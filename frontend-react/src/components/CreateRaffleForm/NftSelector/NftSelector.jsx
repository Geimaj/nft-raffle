...
import { useConnectedSigner, useContracts } from '../../../providers/ContractsProvider';
...
const NftSelector = ({
  ...
  function renderNfts(contract){
    ...
    {nfts.map((nft, i) => <div key={i}>
      {nft.toNumber()}
      <input type="radio" name="nft-select" onChange={() => handleTokenSelected(contract, nft)}/>
      </div>
      )}
  </div>)
  }
